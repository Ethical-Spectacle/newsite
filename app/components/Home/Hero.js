    ...
    <div className="bg-white">
      ...
      <div className="scroll-container">
        <div className="size-72 scroll-item">
          ...
          <h2 className="flex flex-row justify-end pr-5 text-xl">Swipe</h2>
        </div>
      ...
      <div className="flex flex-row justify-start overflow-hidden h-15 items-center bg-black py-3">
        <h1 className="whitespace-nowrap text-white text-lg py-3 px-2 ml-5 text-right">🤖 check our leaderboard —&gt; </h1>
      </div>
