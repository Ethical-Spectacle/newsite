    ...
    <div className="bg-white">
      <div className="scroll-container hide-scrollbar">
        <div className="size-72 scroll-item">
          <h1 className="inline-block drop-shadow-lg border-black  border-4 p-3 m-2 ml-10 mt-6 text-5xl whitespace-nowrap md:ml-20 md:mt-10 font-bold">
          ...
          <h2 className="flex flex-row justify-end pr-5 mr-10 text-xl md:flex hidden">
            <PiHandSwipeLeftDuotone className="mt-1 text-5xl" />
            Scroll
          </h2>
        </div>
        ...
        <a href="/account" className="size-72 scroll-item p-3 bg-black flex">
          <h1 className="text-5xl font-semibold mb-2 mt-2 text-white flex-col justify-start">
            Become a Member.
          </h1>
          <div className="flex flex-col justify-end text-white text-8xl">
            <IoMdArrowForward />
          </div>
        </a>
      </div>
