...
function Contact() {
  return (
    <section className="w-full flex justify-center mb-10">
        <section className="w-full max-w-1440 flex min-h-[50vh] flex-col justify-center items-center mx-5 p-2 bg-slate-800 text-cream space-y-10 pink-box-shadow-style">
