    ...
    <div className="bg-white">
      ...
      <div className="scroll-container hide-scrollbar flex md:justify-center justify-start">
        ...
        <div className="w-96 scroll-item border border-black  p-5">
          ...
          <p className="mb-5">Platform: Environment for LLM agents to interact with eachother at scale, spreading ideas.</p>
          <p className="mb-5">Paper: Can a network of LLM agents effectively filter out toxic ideas, while promoting good ones?</p>
        </div>

        <div className="w-96 scroll-item border border-black border-r-2 p-5">
          {/* can someone add something here, fill the space, top right aligned */}
          <p className="text-2xl font-semibold mb-2">Hackathon.</p>
          <p className="mb-5">Scheduled for Oct. 2024, participants get 48 hours to build a front-end application that interacts with our API, designing the logic for when/which agents interact. A demo of the applicaiton will be pitched to a panel of private capital investors.</p>
        </div>
      </div>
