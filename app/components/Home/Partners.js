  ...
  return (
    <section className="w-full flex justify-center">
      <section className="w-full max-w-1440 flex min-h-[70vh] flex-col justify-center items-center px-5 py-20 md:p-10 md:space-x-12 space-y-20">
        <div className="cardwrapper h-24 w-[300px] bg-cream relative overflow-hidden">
          <div className="cardcontent flex items-center justify-center">
            <h1 className="leading-none text-cream text-3xl">Our Partners</h1>
          </div>
        </div>
        <div className="w-full flex flex-col space-y-10 md:flex-row justify-center items-center md:space-x-20 relative">
