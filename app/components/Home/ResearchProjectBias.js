  ...
  return (
    <div className="bg-white sm:bg-black sm:py-10">
      <div className="scroll-container hide-scrollbar flex md:justify-center justify-start">
        <div className="w-full md:w-96 md:h-80 scroll-item border sm:border-white border-black sm:text-white border-l-2 px-5 pt-5">
        ...
        <div className="w-full md:w-96 md:h-80 scroll-item sm:border-white border border-black  p-5">
        ...
        <div className="w-full md:w-96 md:h-80 scroll-item sm:border-white border  border-black border-r-2 p-5">
