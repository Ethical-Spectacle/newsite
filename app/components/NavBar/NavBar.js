...
function NavBar() {
  ...
  return (
    <nav className='outside-container border-b border-black'>
      <div className='nav-boxed h-[100px] px-5 items-center justify-between'>
        ...
        <div className='border-l border-black h-[100%] w-2/3 md:w-1/4 flex items-center justify-end'>
          {logged ? (
